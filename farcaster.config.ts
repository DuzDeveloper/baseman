...
export const farcasterConfig = {
  ...
  frame: {
    ...
    screenshotUrls: ["https://baseman.vercel.app/images/scr1.png"],
    name: "Baseman",
    iconUrl: `https://baseman.vercel.app/images/icon.png`,
    splashImageUrl: `https://baseman.vercel.app/images/splash.png`,
    splashBackgroundColor: "#1f0cd1",
    homeUrl: "https://baseman.vercel.app",
    webhookUrl: "https://baseman.vercel.app/api/webhook",
    primaryCategory: "games",
    tags: ["games","flappybird","baseman"],
    heroImageUrl: "https://baseman.vercel.app/images/heroog.png",
    tagline: "",
    ogTitle: "Baseman",
    ogDescription: "A game inspired on FlappyBirds",
    ogImageUrl: "https://baseman.vercel.app/images/heroog.png",
  },
}  as const;